					...
					<ul class="nav navbar-nav">
						...
						<li class="classic-menu-dropdown mega-menu-dropdown">
							<a href="#" class=" megamenu-dropdown" data-close-others="true"> <i
									class="material-icons">assignment</i> Manage
								<i class="fa fa-angle-down"></i>
...
<!-- Mirrored from radixtouch.in/templates/admin/smart/source/full/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 10 Feb 2021 01:52:42 GMT -->
</html>